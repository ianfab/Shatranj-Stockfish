...
enum Value : int {
  ...
  PawnValueMg   = 171,   PawnValueEg   = 249,
  BishopValueMg = 315,   BishopValueEg = 346,
  QueenValueMg  = 447,   QueenValueEg  = 570,
  KnightValueMg = 1006,  KnightValueEg = 1256,
  RookValueMg   = 1437,  RookValueEg   = 2200,
