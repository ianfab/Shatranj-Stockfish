...
Value PieceValue[PHASE_NB][PIECE_NB] = {
  { VALUE_ZERO, PawnValueMg, BishopValueMg, QueenValueMg, KnightValueMg, RookValueMg },
  { VALUE_ZERO, PawnValueEg, BishopValueEg, QueenValueEg, KnightValueEg, RookValueEg }
};
...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(  0,  0), S(-13,-31), S(-25,-37), S(  0,  0) },
   { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
   { S( -9,-23), S(  0,  0), S(  0,  0), S( 11, 16) },
   { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
   { S(  0,  0), S( 27, -4), S( 16, -7), S(  0,  0) },
   { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
   { S(-23,-34), S(  0,  0), S(  0,  0), S( -2,  6) },
   { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) }
  },
  { // Queen
